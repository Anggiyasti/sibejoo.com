<?php
class Medudrive extends CI_Model {
   ...
   switch ($params['search']['sortBy']) {
    ...
    break;
        ...
        public function get_modulteratas(){
          $this->db->select('mdl.id, mdl.judul, mdl.deskripsi, mdl.url_file, mdl.publish,mdl.uuid,mdl.id_tingkatpelajaran,mdl.download,mdl.statusAksesFile');
          $this->db->from('tb_modul as mdl');
          $this->db->where('mdl.status','1');
        ...
        public function modulsd(){
          $this->db->select('mdl.statusAksesFile,mdl.id, mdl.judul, mdl.deskripsi, mdl.url_file, mdl.publish,mdl.uuid,mdl.id_tingkatpelajaran,tp.id');
          $this->db->from('tb_modul as mdl');
