...
class Ortuback_model extends CI_Model{
	...
	public function get_siswa_not_ortu($records_per_page,$pageSelek,$keySearch)
	{
		...
		$this->db->select("s.id as idSiswa,s.namaDepan,s.namaBelakang,p.email,p.namaPengguna");
	...
	{
		$this->db->select("s.id as idSiswa,s.namaDepan,s.namaBelakang,penggunaSiswa.email,penggunaSiswa.namaPengguna as np_siswa,penggunaOrtu.namaPengguna as np_ortu,tua.namaOrangTua, penggunaOrtu.id as id_np_ortu");
