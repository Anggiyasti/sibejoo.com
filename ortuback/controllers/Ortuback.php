			...
			$param_reset_pswd_ortu=$value->id_np_ortu.",'".$value->np_ortu."'";
			 ...
			 $tb_ortu.='<tr>
						...
						<td>
							...
							<button class="btn btn-sm btn-danger" title="Hapus" onclick="del_ortu('.$param_reset_pswd_ortu.')"><i class="ico-close3"></i></button>
						</td>
			 </tr>
			 ';
			$n++;
