...
<section class="page-header page-header-block nm" style="background: white">
    <!-- pattern -->
    <!--/ pattern -->
    <div class="container pt15 pb15">
        <div class="">
            <div class="page-header-section text-center">
                <img src="https://sibejoo.com/img/logo-sibejoo.png" alt>
  ...
  <div class="panel panel-default"  style="min-height:170px;">
   ...
   <div class="panel-heading">
    <div class="row">
     ...
     <div class="text-center"> <h4> Waktu <span id="timer"></span></h4></div>
