    ...
    <section class="inner-header divider parallax layer-overlay overlay-dark-5" data-bg-img="http://placehold.it/1920x1280">
      <div class="container pt-70 pb-20">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-md-12">
              <h2 class="title text-white text-center">EDU DRIVE</h2>
          ...
          <div class="col-xs-12 col-sm-6 col-md-8 hvr-float-shadow mb-sm-30">
            <div class="pricing-table maxwidth400">
              ...
              <div class=" bg-white border-1px p-30 pt-20 pb-20">
                ...
                <h4>Edu drive ini semacam gudang file, yang isinya macam2 jenis file yang bisa digunakan untuk belajar. Misalnya di edudrive ada soal-soal UN terbaru, Soal SMBPTN terbaru, Prediksi soal UAS dll. Kalian bisa mengakses atau mendownloadnya sesuka kalian.</h4>
              </div>
            </div>
          </div>
          <div class="col-xs-12 col-sm-6 col-md-2 hvr-float-shadow mb-sm-30">
