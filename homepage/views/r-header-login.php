      ...
      <div class="container">
        <nav id="menuzord" class="menuzord bg-theme-colored pull-left flip menuzord-responsive"><a href="javascript:void(0)" class="showhide" style="display: none;"><em></em><em></em><em></em></a>
          <ul class="menuzord-menu menuzord-indented scrollable" style="max-height: 400px;">
            ...
            <li><a href="<?=base_url('welcome') ?>">Video<span class="indicator"></a></li>
            <li><a href="<?=base_url('welcome') ?>">Konsultasi<span class="indicator"></a></li>
            <li><a href="<?=base_url('welcome') ?>">Try Out<span class="indicator"></a></li>
            <li><a href="<?=base_url('welcome') ?>">Latihan<span class="indicator"></a></li>
            <li><a href="<?=base_url('welcome') ?>">Pesan<span class="indicator"></a></li>
            <li><a href="<?=base_url('welcome') ?>">Edu Drive<span class="indicator"></a></li>
            <li><a href="<?=base_url('welcome') ?>">Learning Line<span class="indicator"></a></li>
            <li><a href="<?=base_url('welcome') ?>">Halo, <?=$this->session->userdata('NAMASISWA') ?>!<span class="indicator"></a></li>
