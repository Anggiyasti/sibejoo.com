<!-- Start main-content -->
  <div class="main-content">
    ...
    <section>
      ...
      <label class="btn cws-button  btn-primary  small" title="Tampilkan Jenis Video Room" onclick="now()"> 
        <input type="radio" name="options" autocomplete="off" class="form-control"> Now
      </label> 

      <label class="btn cws-button  btn-primary   small"  title="Tampilkan Jenis Video Screen" onclick="soon()"> 
