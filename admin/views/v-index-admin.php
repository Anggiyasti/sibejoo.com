  ...
  <li>
   <a href="<?=base_url('index.php/modulonline/daftar_modul')?>" data-target="#submodul" data-toggle="submenu"  >
    <span class="text">Daftar Modul</span>
          ...
          <li>
            <a href="javascript:void(0);" data-target="#donate" data-toggle="submenu" data-parent=".topmenu">
            <span class="figure"><i class="ico-dollar"></i></span>
            <span class="text">Donate</span>
            <span class="arrow"></span>
            </a>
            <ul id="donate" class="submenu collapse ">
              <li>
                <a href="<?=base_url('index.php/donasiback')?>">
                <span class="text">Donasi</span>
                </a>
              </li>
              <li>
                <a href="<?=base_url('index.php/donaturback')?>">
                <span class="text">Donatur</span>
                </a>
              </li>
            </ul>
          </li>
